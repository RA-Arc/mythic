...
export const WEAPON_CATALOG: GearItem[] = [
  ...
  },
  {
    ...
    critChance: 0.35,
    shadowBonus: 100,
    description: 'Forged obsidian shinobi blades with poisoned edge and throwing kunai.',
    lore: 'Passed down through ninety generations of clan grandmasters.',
    colorScheme: {
      primary: '#18181b',
      secondary: '#ef4444',
      glow: '#f87171',
    },
    perks: ['perk_crit_damage', 'perk_combo_surge'],
    iconName: 'Zap',
