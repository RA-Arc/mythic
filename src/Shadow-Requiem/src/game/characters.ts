...
export const PLAYABLE_CHARACTERS: PlayableCharacter[] = [
  {
    id: 'char_ninja',
    name: 'Shadow Ninja',
    title: 'Grandmaster Shinobi',
    faction: 'heralds',
    avatarIcon: 'Zap',
    rarity: 'legendary',
    level: 2,
    quote: 'From the shadows I strike, into the mist I vanish.',
    lore: 'Supreme grandmaster of the ancient Shinobi clan who commands the mini-ninja squad in the idle realms. In manual arena duels, the Shadow Ninja employs deadly dual ninjato, smoke clone substitution, and rapid shuriken flurries.',
    signatureWeapon: WEAPON_CATALOG[6] || WEAPON_CATALOG[0], // Shadow Ninjato & Kunai
    ...
    signatureAbility: {
      name: 'Shinobi Clone Decapitation',
      description: 'Blinds the opponent with smoke and summons mini-ninja shadow clones for an inescapable multi-hit aerial execution.',
      tag: 'Shinobi Deception',
    },
    unlockCondition: 'Unlocked by default as Master of the Shadow Clan.',
    isUnlockedDefault: true,
  },
  {
    id: 'char_bloodweaver',
    name: 'Crimson Bloodweaver',
    title: 'Mistress of Sanguine Threads',
    faction: 'heralds',
    avatarIcon: 'Flame',
    rarity: 'mythic',
    level: 4,
    quote: 'Every heartbeat is a thread. I simply pull until you unravel.',
    lore: 'A primordial sorceress who commands the river of life and death. Armed with the fabled Bloodweaver Kusarigama, her sickle drains vitality across both the idle realm and manual duel arena, weaving crimson blood tendrils that crush her enemies.',
    ...
    signatureAbility: {
      name: 'Sanguine Thread Cataclysm',
      description: 'Unleashes a vortex of barbed blood chains that binds the enemy and siphons 30% of their life directly into the Bloodweaver.',
      tag: 'Blood Siphon Mastery',
    },
    unlockCondition: 'Unlocked by default as Mistress of Sanguine Threads.',
    isUnlockedDefault: true,
  },
  {
    id: 'char_raven',
